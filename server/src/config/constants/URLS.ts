...
const SERVER_URL = CREDENTIALS.SERVER_URL as string;
const SERVER_PORT = CREDENTIALS.SERVER_PORT as string;
const SERVER_FULL_URL = SERVER_PORT
  ? `${SERVER_URL}:${SERVER_PORT}`
  : SERVER_URL;

const CLIENT_URL = CREDENTIALS.CLIENT_URL as string;
const CLIENT_PORT = CREDENTIALS.CLIENT_PORT as string;
