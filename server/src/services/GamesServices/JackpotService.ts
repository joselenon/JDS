...
const jackpotCacheKey = getRedisKeyHelper('last_jackpot');
const jackpotDuration = 1000 * 1000;
...
class JackpotService {
  ...
  static async updateJackpots(
    ...
    try {
      ...
      // Redis Update
      const jackpotRedisPayload = { ...jackpotInRedis, ...payload };
      if (payload.bets) {
